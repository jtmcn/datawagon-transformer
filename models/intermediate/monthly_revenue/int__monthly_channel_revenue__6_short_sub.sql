with
    ...
    shorts__video__sub_rev as (
        ...
        select report_date_key, channel_id, sum(channel_revenue) as shorts__sub_revenue
        from {{ ref("int__shorts__video__sub_rev__daily_channel_rev") }}
    ...
    int__monthly_channel_revenue__6_short_sub as (
        ...
        left join
            ...
            on channel_revenue.report_date_key = shorts_sub.report_date_key
